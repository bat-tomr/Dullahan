Dullahan, the headless X11 installer
...
sudo gdebi dullahan_<version>_amd64.deb
sudo reboot
...
Running
-------
In order to get access to the desktop remotely, we recommend installing vnc or b11 from Colorado Code Craft.
